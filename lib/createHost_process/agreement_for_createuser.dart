...
import 'package:firebase_auth/firebase_auth.dart';
import 'package:team_call/setting.dart';
import 'c_signIn_page.dart';



class AgreementForCreateUser extends StatefulWidget {
  ...
  @override
  _AgreementForCreateUserState createState() => _AgreementForCreateUserState();
}

class _AgreementForCreateUserState extends State<AgreementForCreateUser> {
